"""Config flow to configure the OpenWrt integration."""
...
class OpenWrtFlowHandler(ConfigFlow, domain=DOMAIN):
    ...
    async def _async_check_connection(
        ...
        """Attempt to connect the OpenWrt router."""
        ...
        try:
            ...
            _LOGGER.error("Error connecting to the OpenWrt router at %s", host)
            return RESULT_CONN_ERROR, None

        except Exception:  # pylint: disable=broad-except
            _LOGGER.exception(
                "Unknown error connecting with OpenWrt router at %s", host
            )
